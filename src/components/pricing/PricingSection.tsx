    ...
    <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8 max-w-2xl mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-4xl font-bold text-text-primary mb-4">
          An accessible and affordable discovery journey for a better you
        </h2>
        <p className="text-text-secondary text-lg max-w-2xl mx-auto mb-8">
          Unlock Your Potential: Begin with Mendley for Free, and Embrace Mendley Pro to Discover the Extraordinary You
        </p>
      </div>
