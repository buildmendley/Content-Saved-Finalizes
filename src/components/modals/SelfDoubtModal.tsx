          ...
          >
            ...
            <div className="p-6 border-b border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Kinds of Self-Doubt</h2>
                  <p className="text-gray-600 mt-1">Grapsing and Comprehending the various forms of doubt</p>
                </div>
                <button
                  onClick={onClose}
